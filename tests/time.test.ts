...
import { defaultWeeklyCutoffUtc, defaultWeeklyScrapeUtc, isBeforeCutoff } from "../src/backend/time";
...
describe("weekly cutoff", () => {
  ...
  it("sets Tuesday 10:00 AM America/Chicago as the default scrape time", () => {
    expect(defaultWeeklyScrapeUtc(new Date("2026-09-08T12:00:00.000Z"))).toBe("2026-09-08T15:00:00.000Z");
  });
