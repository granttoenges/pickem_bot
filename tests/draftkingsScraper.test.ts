...
describe("DraftKings parser", () => {
  it("stores normalized spread, team total, moneyline, and raw payload data", () => {
    ...
    expect(parsed.lines.map((line) => line.market).sort()).toEqual(["moneyline", "spread", "team_total"]);
